...
We advise users to run or update to the most recent release of the `nginx_aws_signature`. Older versions of the `nginx_aws_signature` may not have all enhancements and/or bug fixes applied to them.
